...
// 获取书城分类列表
export const getExploreTagList = params => http.get('/explore/tag/list', { params })
// 获取书城的书籍列表
export const explore = params => http.get('/search/explore', { params })
// 获取搜索历史记录
...
// 根据书名查询书籍
export const searchBookName = params => http.get('/search/book/singleSource', { params })
// 判断当前书籍是否已经加入书架
