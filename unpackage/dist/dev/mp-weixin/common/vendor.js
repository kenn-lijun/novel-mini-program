...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"NODE_ENV":"development","VUE_APP_NAME":"AiNingBook","VUE_APP_PLATFORM":"mp-weixin","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
module.exports = {
  ...
  // baseUrl: 'https://4y11642z93.yicp.fun',
  // 超时
  timeout: 30000,
  // 禁用 Cookie 等信息
...
"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.deleteCache = exports.getCache = exports.cache = exports.getChapters = exports.saveShelf = exports.shelfIsExit = exports.searchBookName = exports.saveBrowseHistory = exports.deleteBrowseHistory = exports.getBrowseHistories = exports.getBookInfo = exports.getFirstLink = exports.deleteShelf = exports.getShelfList = exports.saveReadHistory = exports.saveSearchHistory = exports.getSearchHistories = exports.getBooksByResourceSort = exports.getResourceSorts = exports.getResource = exports.getOpenid = void 0; //请求工具参考https://ext.dcloud.net.cn/plugin?id=392
var http = uni.$u.http;
...
// 获取书源对应的书籍分类列表
exports.getResource = getResource;var getResourceSorts = function getResourceSorts(params) {return http.get('/source/book/type/listBySource', { params: params });};
// 获取书源对应的某个分类下面的书籍列表
exports.getResourceSorts = getResourceSorts;var getBooksByResourceSort = function getBooksByResourceSort(params) {return http.get('/search/listBySort', { params: params });};
// 获取搜索历史记录
exports.getBooksByResourceSort = getBooksByResourceSort;var getSearchHistories = function getSearchHistories(params) {return http.get('/search/history/list', { params: params });};
// 保存搜索历史记录
...
// 获取缓存的书籍第一章链接
exports.deleteShelf = deleteShelf;var getFirstLink = function getFirstLink(params) {return http.get('/search/getFirstLinkByCache', { params: params });};
// 获取章节内容详情
exports.getFirstLink = getFirstLink;var getBookInfo = function getBookInfo(params) {return http.get('/search/info', { params: params });};
// 获取浏览历史
...
// 根据书名查询书籍
exports.saveBrowseHistory = saveBrowseHistory;var searchBookName = function searchBookName(params) {return http.get('/search/searchByBookName', { params: params });};
// 判断当前书籍是否已经加入书架
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _en = _interopRequireDefault(__webpack_require__(/*! ./en.json */ 337));
var _zhHans = _interopRequireDefault(__webpack_require__(/*! ./zh-Hans.json */ 338));
var _zhHant = _interopRequireDefault(__webpack_require__(/*! ./zh-Hant.json */ 339));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}var _default =
{
  en: _en.default,
  'zh-Hans': _zhHans.default,
  'zh-Hant': _zhHant.default };exports.default = _default;
...
var _es = _interopRequireDefault(__webpack_require__(/*! ./es.json */ 357));
var _fr = _interopRequireDefault(__webpack_require__(/*! ./fr.json */ 358));
